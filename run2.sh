...
/usr/bin/env /usr/lib/jvm/jdk-17.0.2+8/bin/java -XX:+ShowCodeDetailsInExceptionMessages -cp /home/bogdan/Desktop/UPM/Estructura/OdioEstructura/bin run.App $EMU $CONF $BIN $regDisp $rDisp $spaceDisp $MPDisp $nextStep $startMP